...
namespace units {
  ...
  UNIT_ADD_WITH_METRIC_PREFIXES_STANDARD_TYPES(time, minute, minutes, min, unit<std::ratio<60>, seconds>)
  UNIT_ADD_WITH_METRIC_PREFIXES_STANDARD_TYPES(time, hour, hours, hr, unit<std::ratio<60>, minutes>)
//  UNIT_ADD_WITH_METRIC_PREFIXES_STANDARD_TYPES(time, day, days, d, unit<std::ratio<24>, hours>)
//  UNIT_ADD_WITH_METRIC_PREFIXES_STANDARD_TYPES(time, week, weeks, wk, unit<std::ratio<7>, days>)
//  UNIT_ADD_WITH_METRIC_PREFIXES_STANDARD_TYPES(time, year, years, yr, unit<std::ratio<365>, days>)
//  UNIT_ADD_WITH_METRIC_PREFIXES_STANDARD_TYPES(time, julian_year, julian_years, a_j,	unit<std::ratio<31557600>, seconds>)
//  UNIT_ADD_WITH_METRIC_PREFIXES_STANDARD_TYPES(time, gregorian_year, gregorian_years, a_g, unit<std::ratio<31556952>, seconds>)
#endif
